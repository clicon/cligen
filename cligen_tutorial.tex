...
It is possible to pre-set a set of labels that are filtered by default using {\tt cligen\_reftree\_filter\_set}, in which you can enable a label in areference using eg {\tt @T, @add:local;}.

...
% Title
%
\title {CLIgen Manual\\ {\small CLIgen version 5.1}}
...
hide : specifies that a command is not visible in auto completion, meaning 
       when listing or completing commands with '?' and 'TAB'. This can be useful if there are

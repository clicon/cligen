...
For example command syntax, please see the {\tt tutorial.cli} file in the source release.
...
Reference documentation is referred to doxygen. To generate a doxygen manual, please use {\tt make doc} in the cligen directory.

...
#ifndef CLIGEN_HISTORY_INTERNAL_H
#define CLIGEN_HISTORY_INTERNAL_H
...
int   hist_copy_pos(cligen_handle h);
int   hist_copy_prev(cligen_handle h);
int   hist_copy_next(cligen_handle h);

#endif /* CLIGEN_HISTORY_INTERNAL_H */
